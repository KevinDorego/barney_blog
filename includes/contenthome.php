        ...
        echo "<article class='col-block'>
                ...
                <div class='item-entry' data-aos='zoom-in'>
                    <div class='item-entry__thumb'>
                        <a href='index.php?page=details&id=".$value['id']."' class='item-entry__thumb-link'>
                    ...
                    <div class='item-entry__text'>    
                        ...
                        <h1 class='item-entry__title'><a href='index.php?page=details&id=".$value['id']."'>".($value['post_title'])."</a></h1>
