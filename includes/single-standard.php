        ...
        <article class="row entry format-standard">
            ...
            <div class="entry__media col-full">
                <div class="entry__post-thumb">
                    <img src="images/thumbs/post/<?php echo $post['img']?>" 
                         srcset="images/thumbs/post/<?php echo $post['img']?>, 
                                 images/thumbs/post/<?php echo $post['imggrande']?>, 
                                 images/thumbs/post/<?php echo $post['img']?>" 
            ...
            <div class="entry__header col-full">
                ...
                <ul class="entry__header-meta">
                    <li class="date"><?php
                         ...
                         echo date('m-d-Y',strtotime($post['up_date']));
                    ...
                    <li class="byline">
                        ...
                        <a href="#0"><?php
                         ...
                         echo utf8_encode($post['firstname']);
